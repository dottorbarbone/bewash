...
export default function ReservationCard({ reservation, onEdit }) {
  ...
  return (
    ...
    >
      <CardMedia
        component="div"
        sx={{ height: 65, background: backgroundColor }}
      >
        <Box
          sx={{
            display: "flex",
      ...
      <CardContent>
        ...
        >
          <Avatar
            sx={{ backgroundColor: backgroundColor, marginRight: "10px" }}
          >
            <AccountCircleIcon />
          </Avatar>
          <Typography
        ...
        >
          ...
          >
            ...
            <Typography variant="body1">
              Tempo di impiego: {reservation.tempoDiImpiego} ore
            </Typography>
          </Box>
          <Box
            sx={{ display: "flex", alignItems: "center", marginBottom: "5px" }}
